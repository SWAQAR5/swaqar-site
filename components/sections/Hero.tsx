        ...
        ─────────────────────────────────────────────────────────────────── */}
          ...
          "
                >
                    ...
                    {/* Region: Asia */}
                    <div className="sm:ml-auto flex flex-wrap gap-2 sm:justify-end">
                        {["Governance-Led", "Asset-Light", "Non-Custodial"].map((label) => (
                            <span
                                key={label}
                                className="text-[10px] font-semibold tracking-[0.1em] uppercase border border-white/15 text-[#A0AEC0] px-3 py-1.5"
                            >
                                {label}
                            </span>
                        ))}
