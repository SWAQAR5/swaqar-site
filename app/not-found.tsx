...
export default function NotFound() {
  return (
    <main style={{background:'var(--parchment)',minHeight:'100vh',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'80px 24px',textAlign:'center'}}>
      <div style={{fontSize:'.56rem',letterSpacing:'.36em',textTransform:'uppercase',color:'var(--gold)',fontWeight:600,marginBottom:'16px'}}>404</div>
      ...
      <Link href="/" style={{fontSize:'.78rem',letterSpacing:'.06em',textTransform:'uppercase',color:'var(--gold)',fontFamily:'var(--sans)',textDecoration:'none',border:'1px solid var(--gold)',padding:'12px 24px'}}>← Return Home</Link>
    </main>
  );
}
